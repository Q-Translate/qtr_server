...
* Creating features
  ...
  the layout and look of a freshly installed Qtr_server site):
  #+BEGIN_EXAMPLE
  ...
  Other features that I have created are: /qtr_disqus/,
  /qtr_invite/, /qtr_sharethis/,
  /qtr_captcha/, /qtr_drupalchat/,
  /qtr_janrain/, /qtr_simplenews/,
  /qtr_mass_contact/, /qtr_googleanalytics/, etc.  In
...
* Making features configurable
  ...
  administrator/maintainer of the (Qtr_server) application an easy
  ...
  section of Qtr_server configurations. This admin/config page
